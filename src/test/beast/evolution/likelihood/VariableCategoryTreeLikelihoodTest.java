...
// import beast.base.evolution.VariableCategoryGammaSiteModel.VariableCategoryGammaSiteModel;
...
import rbbeast.evolution.likelihood.VariableCategoryTreeLikelihood;
import rbbeast.evolution.sitemodel.VariableCategoryGammaSiteModel;
 ...
 * *
 */
public class VariableCategoryTreeLikelihoodTest  {

    public VariableCategoryTreeLikelihoodTest() {
        super();
    }

    protected TreeLikelihood newTreeLikelihood() {
    	//System.setProperty("java.only","true");
        return new VariableCategoryTreeLikelihood();
    }
    ...
    public void testJC69Likelihood() throws Exception {
        ...
        VariableCategoryGammaSiteModel VariableCategoryGammaSiteModel = new VariableCategoryGammaSiteModel();
        VariableCategoryGammaSiteModel.initByName("mutationRate", "1.0", "categoryCount", "1", "substModel", JC);

        TreeLikelihood likelihood = newTreeLikelihood();
        likelihood.initByName("data", data, "tree", tree, "siteModel", VariableCategoryGammaSiteModel);
        double logP = 0;
        logP = likelihood.calculateLogP();
        assertEquals(logP, -1992.2056440317247, BEASTTestCase.PRECISION);

        likelihood.initByName("useAmbiguities", true, "data", data, "tree", tree, "siteModel", VariableCategoryGammaSiteModel);
        logP = likelihood.calculateLogP();
        assertEquals(logP, -1992.2056440317247, BEASTTestCase.PRECISION);
    }
    ...
    public double[] testJC69Likelihood(Alignment data, Tree tree) throws Exception {
        ...
        VariableCategoryGammaSiteModel VariableCategoryGammaSiteModel = new VariableCategoryGammaSiteModel();
        VariableCategoryGammaSiteModel.initByName("mutationRate", "0.6", "substModel", JC);
        ...
        TreeLikelihood likelihood = newTreeLikelihood();
        likelihood.initByName("data", data, "tree", tree, "siteModel", VariableCategoryGammaSiteModel, "scaling", TreeLikelihood.Scaling.none);        
        double[] logP = new double[2];
        logP[0] = likelihood.calculateLogP();
        System.out.println(logP[0]);

        System.out.println("With tip likelihoods:");
        likelihood.initByName("useTipLikelihoods", true, "data", data, "tree", tree, "siteModel", VariableCategoryGammaSiteModel, "scaling", TreeLikelihood.Scaling.none);
    ...
    public void testAscertainedJC69Likelihood() throws Exception {
        ...
        VariableCategoryGammaSiteModel VariableCategoryGammaSiteModel = new VariableCategoryGammaSiteModel();
        VariableCategoryGammaSiteModel.initByName("mutationRate", "1.0", "categoryCount", "1", "substModel", hky);
    ...
    public void testHKY85GLikelihood() throws Exception {
        ...
        VariableCategoryGammaSiteModel VariableCategoryGammaSiteModel = new VariableCategoryGammaSiteModel();
        VariableCategoryGammaSiteModel.initByName("mutationRate", "1.0", "categoryCount", "4",
                "shape", "0.137064",
    ...
    public void testHKY85ILikelihood() throws Exception {
        ...
        VariableCategoryGammaSiteModel VariableCategoryGammaSiteModel = new VariableCategoryGammaSiteModel();
        VariableCategoryGammaSiteModel.initByName("mutationRate", "1.0", "categoryCount", "1",
                "shape", "0.137064",
    ...
    public void testGTRLikelihood() throws Exception {
        ...
        likelihood.initByName("useAmbiguities", false, "data", data, "tree", tree, "siteModel", VariableCategoryGammaSiteModel);
        logP = likelihood.calculateLogP();
        assertEquals(logP, -1969.145839307625, BEASTTestCase.PRECISION);
    }
    ...
    public void testGTRILikelihood() throws Exception {
        ...
        VariableCategoryGammaSiteModel.initByName("mutationRate", "1.0", "categoryCount", "1",
                ...
                "substModel", gsm);
        //VariableCategoryGammaSiteModel.init("1.0", 1, null, "0.5", gsm);
    ...
    void aminoacidModelTest(SubstitutionModel substModel, double expectedValue) throws Exception {
        ...
        VariableCategoryGammaSiteModel VariableCategoryGammaSiteModel = new VariableCategoryGammaSiteModel();
        VariableCategoryGammaSiteModel.initByName("mutationRate", "1.0", "categoryCount", "1", "substModel", substModel);
    ...
    public void testSDolloLikelihood() throws Exception {
        ...
        VariableCategoryGammaSiteModel VariableCategoryGammaSiteModel = new VariableCategoryGammaSiteModel();
        VariableCategoryGammaSiteModel.initByName("mutationRate", "1.0", "categoryCount", "1", "substModel", SDollo);

        TreeLikelihood likelihood = newTreeLikelihood();
        likelihood.initByName("data", data, "tree", tree, "siteModel", VariableCategoryGammaSiteModel);

        double logP = 0;
        likelihood.initByName("data", data, "tree", tree, "siteModel", VariableCategoryGammaSiteModel, "useAmbiguities", true);
        logP = likelihood.calculateLogP();
    ...
    public void testBinaryCovarionLikelihood() throws Exception {
        ...
        VariableCategoryGammaSiteModel VariableCategoryGammaSiteModel = new VariableCategoryGammaSiteModel();
        VariableCategoryGammaSiteModel.initByName("mutationRate", "1.0", "categoryCount", "1", "substModel", covarion);
    ...
    public void testMarginalisationOfLikelihoodNucleotide() throws Exception {
        ...
        VariableCategoryGammaSiteModel VariableCategoryGammaSiteModel = new VariableCategoryGammaSiteModel();
        VariableCategoryGammaSiteModel.initByName("mutationRate", "1.0", "categoryCount", "1", "substModel", gsm);
    ...
    public void testBeagleRNALikelihood() throws Exception {
        ...
        VariableCategoryGammaSiteModel VariableCategoryGammaSiteModel = new VariableCategoryGammaSiteModel();
        VariableCategoryGammaSiteModel.initByName("categoryCount", "1", "substModel", new JukesCantor());

        TreeLikelihood likelihoodNoBeagle = newTreeLikelihood();

        likelihoodNoBeagle.initByName("data", data, "tree", tree, "siteModel", VariableCategoryGammaSiteModel);
        ...
        likelihoodBeagle.initByName("data", data, "tree", tree, "siteModel", VariableCategoryGammaSiteModel);
