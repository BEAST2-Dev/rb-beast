...
abstract public class PartitionedLikelihoodCore {
...
//	abstract public void setPaddedNodeMatrices(int iNode, double[] fMatrix);
     ...
     * calculation differs-
     * @param patternIndicator TODO*
     */
    abstract public void calculatePartials(int iNode1, int iNode2, int iNode3, List<Integer> patternIndicator);
     ...
     */
    abstract public void integratePartials(int iNode, double[] fProportions, double[] fOutPartials, List<Integer> patternIndicator);
     ...
     * the patterns *
     */
    abstract public void calculateLogLikelihoods(double[] fPartials, double[] fFrequencies, double[] fOutLogLikelihoods, List<Integer> patternIndicator);


    public void processStack() {
    }

    abstract protected void calculateIntegratePartials(double[] fInPartials, double[] fProportions, double[] fOutPartials, List<Integer> patternIndicator);
